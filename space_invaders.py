...
mixer.music.load("D:/my songs/01 - Chammak Challo.mp3")
mixer.music.play(-1)
    ...
    # if keystroke is pressed check whether its right or left
        if event.type==pg.KEYDOWN:
            ...
            if event.key==pg.K_SPACE:
                    bullet_sound=mixer.Sound("C:/Users/ELCOT/Music/Danganronpa Bullet Sound(MP3_160K).wav")
                    bullet_sound.play()
...
#boundary  creating of enemy
    for i in range(num_of_enemies):
        ...
        if collision:
            explosion_sound=mixer.Sound('C:/Users/ELCOT/Music/THE Boom   Sound Effect(MP3_160K).wav')
