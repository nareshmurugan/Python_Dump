...
5 -7 4
"""
#*uc* the bug to suck the success
import numpy as n
import sympy as s
import math
...
S2=cofactor(arr)#
'''
print("The cofactor of the array A is S2=",S2)
M11=arr[0][0]
M12=arr[0][1]
M13=arr[0][2]
M21=arr[1][0]
...
print("The values of lamda value ʎ = ",ʎ1,',',ʎ2,',',ʎ3) 
...
u=[]
for i in [ʎ1,ʎ2,ʎ3]:
    eq1=s.Eq(Eq1.subs(ʎ,i),0)
    eq2=s.Eq(Eq2.subs(ʎ,i),0)
    eq3=s.Eq(Eq3.subs(ʎ,i),0)
    sol=s.solve((eq1,eq2,eq3),(x,y,z))
    u.append(sol)
print(u)
